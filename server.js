...
const config = {
    env:               'product', // Change to 'sandbox' if testing in sandbox environment
    sign_type:         'RSA',
...
app.post('/api/get-iframe-token', (req, res) => {
    ...
    // As per documentation, merchant_id and sub_merchant_id are pre-configured during initialization
    const params = {
...
app.post('/api/webhook/lianlian', (req, res) => {
    ...
    // SDK handles validation automatically via llNotice
